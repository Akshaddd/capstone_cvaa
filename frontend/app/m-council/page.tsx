  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-slate-50 dark:bg-slate-950">
      ...
      <div className="flex flex-col gap-3 p-4 overflow-y-auto pb-10">
        ...
        <button className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-semibold text-sm py-4 rounded-2xl">Assign to team</button>
      </div>
    </div>
  );
}
