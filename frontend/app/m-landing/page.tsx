      ...
      <main className="flex flex-col gap-4 p-4 pb-10">
        ...
        <div className="rounded-2xl bg-emerald-700 p-6 text-white">
          ...
          <div className="mt-5 flex gap-3">
            <Link
              href="/m-login"
              className="rounded-xl bg-white px-5 py-3 text-sm font-bold text-emerald-700"
            >
              Get started
            </Link>
            <Link
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              { step: "2", title: "Scan it",     desc: "Take photos with your phone camera — our AI does the rest" },
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
          <h3 className="mb-3 text-base font-bold text-slate-900 dark:text-white">What MyAccess does</h3>
          <div className="flex flex-col gap-3">
            {[
              "Photographs of a stop are analysed by an AI detection pipeline to identify accessibility features.",
              "Each detected feature is mapped against the Disability Standards for Accessible Public Transport (DSAPT) 2002.",
              "A structured compliance report is generated with clause-level findings, severity ratings, and recommended actions.",
              "Reports can be submitted directly through the app for follow-up and remediation.",
            ].map((line) => (
        ...
        <Link
          href="/m-login"
          className="block w-full rounded-2xl bg-emerald-700 py-4 text-center text-base font-bold text-white shadow-sm"
        >
